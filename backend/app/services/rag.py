...
SYSTEM_PROMPT_RAG = (
    ...
    "Use the context to inform your response — synthesize a helpful, empathetic reply in "
    "your own words. Do not copy or repeat the context verbatim. "
...
def _build_rag_user_prompt(query: str, tickets: list[RetrievedTicket]) -> str:
    context_lines = []
...
async def generate_rag_answer(
    ...
    user_prompt = _build_rag_user_prompt(query, tickets)
